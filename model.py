...
class Model(object):
    ...
    def _build_model(self):
        ...
        self.top2, _ = tf.nn.top_k(tf.nn.softmax(logits=self.pre_softmax), 2)
...
#             self.y_ll = tf.argmin(self.pre_softmax, 1)
#             self.ll_loss = tf.nn.sparse_softmax_cross_entropy_with_logits(
#                 labels=self.y_ll, logits=self.pre_softmax)
